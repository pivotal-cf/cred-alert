...
type FakeDiffScanRepository struct {
	SaveDiffScanStub        func(lager.Logger, *models.DiffScan) error
	saveDiffScanMutex       sync.RWMutex
	saveDiffScanArgsForCall []struct {
		arg1 lager.Logger
		arg2 *models.DiffScan
	}
...
func (fake *FakeDiffScanRepository) SaveDiffScan(arg1 lager.Logger, arg2 *models.DiffScan) error {
...
func (fake *FakeDiffScanRepository) SaveDiffScanArgsForCall(i int) (lager.Logger, *models.DiffScan) {
	fake.saveDiffScanMutex.RLock()
	defer fake.saveDiffScanMutex.RUnlock()
...
var _ models.DiffScanRepository = new(FakeDiffScanRepository)
