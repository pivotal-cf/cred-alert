...
type FakeIngestor struct {
	IngestPushScanStub        func(lager.Logger, webhook.PushScan)
...
func (fake *FakeIngestor) IngestPushScan(arg1 lager.Logger, arg2 webhook.PushScan) {
...
func (fake *FakeIngestor) IngestPushScanArgsForCall(i int) (lager.Logger, webhook.PushScan) {
	fake.ingestPushScanMutex.RLock()
	defer fake.ingestPushScanMutex.RUnlock()
...
var _ webhook.Ingestor = new(FakeIngestor)
