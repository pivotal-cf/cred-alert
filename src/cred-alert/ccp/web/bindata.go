...
func webTemplatesRepositoryHtml() (*asset, error) {
	...
	info := bindataFileInfo{name: "web/templates/repository.html", size: 606, mode: os.FileMode(436), modTime: time.Unix(1504634887, 0)}
	a := &asset{bytes: bytes, info: info}
	return a, nil
}
