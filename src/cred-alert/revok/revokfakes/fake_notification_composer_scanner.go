...
func (fake *FakeNotificationComposerScanner) recordInvocation(key string, args []interface{}) {
...
var _ revok.NotificationComposerScanner = new(FakeNotificationComposerScanner)
