...
// Client API for Rolodex service
...
func (c *rolodexClient) GetOwners(ctx context.Context, in *GetOwnersRequest, opts ...grpc.CallOption) (*GetOwnersResponse, error) {
	out := new(GetOwnersResponse)
	err := grpc.Invoke(ctx, "/rolodexpb.Rolodex/GetOwners", in, out, c.cc, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
// Server API for Rolodex service
...
func RegisterRolodexServer(s *grpc.Server, srv RolodexServer) {
	s.RegisterService(&_Rolodex_serviceDesc, srv)
}

func _Rolodex_GetOwners_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(GetOwnersRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(RolodexServer).GetOwners(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/rolodexpb.Rolodex/GetOwners",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(RolodexServer).GetOwners(ctx, req.(*GetOwnersRequest))
	}
	return interceptor(ctx, in, info, handler)
}

var _Rolodex_serviceDesc = grpc.ServiceDesc{
	ServiceName: "rolodexpb.Rolodex",
	HandlerType: (*RolodexServer)(nil),
	Methods: []grpc.MethodDesc{
		{
			MethodName: "GetOwners",
			Handler:    _Rolodex_GetOwners_Handler,
		},
	},
...
var fileDescriptor0 = []byte{
	...
	,
}
